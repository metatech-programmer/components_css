const ProgressBarComponents = () => {
    ...
    const textos = {
      titulo_texto: {
        uno: 'Progress Bar One',
        dos: 'Progress Bar Two',
        tres: 'Progress Bar Three',
        cuatro: 'Progress Bar Four',
        cinco: 'Progress Bar Five',
        seis: 'Progress Bar Six'
      }
    }
    ...
    return (
      <div className='flex flex-col gap-y-10'>
        <div className={boxStyle.padre}>
          <h2 className={boxStyle.subtitulo}>Normal Progress Bars:</h2>
          {/* Progress Bar 1 */}
