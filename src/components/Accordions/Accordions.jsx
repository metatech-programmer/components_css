const ButtonComponents = () => {
  const boxStyle = {
    ...
    titulo_texto: {
      titulo_uno: 'Accordion One',
      titulo_dos: 'Accordion Two',
      titulo_tres: 'Accordion Three',
      titulo_cuatro: 'Accordion Four',
      titulo_cinco: 'Accordion Five',
      titulo_seis: 'Accordion Six'
    }
  }
  const textos = {
    titulo_texto: {
    ...
    <div className='flex flex-col gap-y-10'>
      <div className={boxStyle.padre}>
        ...
        <div className={boxStyle.hijo}>
          ...
          ">
            <details className="border bg-transparent p-3" name="first_accordion" open>
              <summary className="font-semibold">Title One</summary>
              <p className="m-4">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
              </p>
            </details>
            <details className="border bg-transparent p-3" name="first_accordion">
